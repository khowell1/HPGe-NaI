...
int main() {
  ...
  double theta[4]={PI/2.0,2.0*PI/2.0,PI/2.0,PI/2.0}; //rad
  double phi[4]={0,0,PI,0}; //rad
...
//need to remember that the angles phi and theta are measured from the current vector, not the origin! 
