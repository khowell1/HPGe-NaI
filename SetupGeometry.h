...
class SetupGeometry
{
 ...
 public:
  ...
  SetupGeometry(Int_t new_volume_number,Double_t new_cyl_radius,Double_t new_cyl_height);//specific
  ...
  void CartPositionUpdater();
  void SetCylPosition();
  Double_t GetCylPosition();
  Double_t PhotonVolumePosition();
